...
# Enable logging to see mult-query generation
...
@traceable(name="adv_rag__create_base_vectorstore", run_type="chain")
...
@traceable(name="adv_rag__demo_multi_query_retriever", run_type="chain")
...
@traceable(name="adv_rag__demo_contextual_compression", run_type="chain")
...
@traceable(name="adv_rag__demo_ensemble_hybrid_search", run_type="chain")
def demo_ensemble_hybrid_search():
    ...
    for query in queries:
        ...
        print(
            f"Semantic top result: {semantic_results[0].page_content[:60]}...")
        print(
            f"Ensemble top result: {ensemble_results[0].page_content[:60]}...")


@traceable(name="adv_rag__emo_parent_document_retriever", run_type="chain")
...
@traceable(name="adv_rag__demo_advanced_rag_chain", run_type="chain")
